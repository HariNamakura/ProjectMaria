...
export class ActivitiesComponent implements OnInit {
  ...
  obtainActivitesList(){
    this._RegisterService.getActivitiesList().subscribe(data =>{
...
getChemicalsList(){
  this._RegisterService.getChemicalsList().subscribe(data =>{
...
saveRegister(){
  ...
  chemicalClas = this.form.get('Plague')?.value,
  ...
  const activity: any = {
   ...
   /*  Location: this.form.get('Location')?.value,
    ...
    if (this.id == undefined) {
      ...
      this._RegisterService.saveActivity(activitiesClas).subscribe(data =>{
      ...
      activity.planID = this.id;
        this._RegisterService.updateActivities(this.id,activity).subscribe(data => {
          this.form.reset();
          this.action = 'Agregar';
          this.id = undefined;
