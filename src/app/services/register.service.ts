...
export class RegisterService {
  ...
  constructor(private http: HttpClient) { }
    ...
    private chemicalAPI = 'api/ActionPlan/';
    ...
    updateActivities(id: Number, activity: any): Observable<any>{
      return this.http.put(this.chemicalAPIUrl + this.chemicalAPI + id, activity);
  }

  saveActivity(activity: activitiesClass): Observable<activitiesClass>{
    return this.http.post<activitiesClass>(this.chemicalAPIUrl + this.chemicalAPI, activity);
}
